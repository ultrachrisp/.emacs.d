...
#+BEGIN_SRC emacs-lisp
  (defconst ces-indent-size 2)
  (setq-default tab-width ces-indent-size)
  (setq-default indent-tabs-mode nil)
...
#+BEGIN_SRC emacs-lisp
  (use-package web-mode
    :mode (("\\.html\\'" . web-mode)
           ...
           ("\\.scss\\'" . web-mode)
           ("\\.sass\\'" . web-mode))
    ;; :custom ((web-mode-markup-indent-offset ces-indent-size)
    ;;          (web-mode-css-indent-offset ces-indent-size)
    ;;          (web-mode-code-indent-offset ces-indent-size))
...
#+BEGIN_SRC emacs-lisp
  (use-package typescript-mode
    :mode (("\\.js\\'" . typescript-mode)
           ...
           ("\\.ts\\'" . typescript-mode)
           ("\\.tsx\\'" . typescript-mode))
    :custom (typescript-indent-level ces-indent-size)
...
#+BEGIN_SRC emacs-lisp
  (use-package json-mode
    :mode (("\\.json\\'" . json-mode))
    ;; :custom (js-indent-level ces-indent-size)
